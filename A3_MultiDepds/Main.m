...
for k=1:4
    i = 0; x = 0; sum_W = 0; tau = 0; delta_tau = 0;
    ...
    %% Step 2
        ...
        while 1
            ...
            T_1 = 1/handle_lambda(tau); % let T_1 be 1 times of the current mean arrival time
...
xlabel('t/s')
ylabel('R(t)')
% legend('\gamma_b=0','\gamma_b=10^-^5','\gamma_b=10^-^4','\gamma_b=10^-^3','Location','Southwest')
